...
int main()
{
    remove("/tmp/rpov2_lottery_registry.bin");
    remove("/tmp/rpov2_lottery_registry.bin.ledger");
    remove("/tmp/rpov2_lottery_commit.log");
    remove("/tmp/rpov2_lottery_evidence.log");
    ...
    RegistryStateStore store("/tmp/rpov2_lottery_registry.bin",
                             "/tmp/rpov2_lottery_commit.log",
                             "/tmp/rpov2_lottery_evidence.log",
                             &proof_verifier,
                             crypto_backend.get(),
                             commit_signer_priv,
                             &commit_signer_id);
